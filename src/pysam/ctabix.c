...
static char __pyx_k_gpfs1_well_gerton_hangphan_Plat[] = "/gpfs1/well/gerton/hangphan/Platypus/src/pysam/ctabix.pyx";
 ...
 */
  ...
  __pyx_codeobj__17 = (PyObject*)__Pyx_PyCode_New(8, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_gpfs1_well_gerton_hangphan_Plat, __pyx_n_s_tabix_index, 533, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 533; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
